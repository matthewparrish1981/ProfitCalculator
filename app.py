...
if page == "New Calculation":
    ...
    if st.session_state.products:
        ...
        if submitted:
            ...
            st.session_state.costs = costs  # save costs for future save

            st.markdown("### 💾 Save This Calculation")
            calc_name = st.text_input("Calculation Name", value=st.session_state.loaded_calc_name or "New Calculation")
